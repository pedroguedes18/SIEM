      ...
      <div class="columnsAboutUs" style="  grid-row-start: 4; grid-row-end: 5; background-color: #CECEF6; justify-content: space-between;">
        ...
        <div style="  grid-row-start: 5; grid-row-end: 6; background-color: white;">
          <div class="Slideshow" align="center">
            ...
            <img class="mySlides" src="{$BASE_URL}Fotos/vw12.jpg" align="center">
            <img class="mySlides" src="{$BASE_URL}Fotos/vw3.jpg" align="center">
            <button class="buttonLeft" onclick="plusDivs(-1)">&#10094;</button>
            <button class="buttonRight" onclick="plusDivs(1)">&#10095;</button>
          </div>

          <script src="{$BASE_URL}JavaScript/Slideshow.js"></script>
        </div>
      </div>
